...
Update 20/06/2022 21:35 UTC

* `action.favorite`: Added for `pt_PT`
* `action.removeFavorite`: Added for `pt_PT`
* `home.syncFavorites`: Added for `pt_PT`
* `home.syncFavorites.gettingArtists`: Added for `pt_PT`
* `menubar.options.zoom`: Added for `pt_PT`
* `settings.header.visual.windowBackgroundStyle.color`: Added for `pt_PT`
* `settings.option.audio.enableAdvancedFunctionality.atmosphereRealizerMode.Z8500A`: Added for `pt_PT`
* `settings.option.audio.enableAdvancedFunctionality.atmosphereRealizerMode.Z8500B`: Added for `pt_PT`
* `settings.option.audio.enableAdvancedFunctionality.atmosphereRealizerMode.Z8500C`: Added for `pt_PT`
* `settings.option.general.keybindings.advanced`: Added for `pt_PT`
* `settings.option.general.keybindings.control`: Added for `pt_PT`
* `settings.option.general.keybindings.interface`: Added for `pt_PT`
* `settings.option.general.keybindings.library`: Added for `pt_PT`
* `settings.option.general.keybindings.session`: Added for `pt_PT`
* `settings.option.visual.accentColor`: Added for `pt_PT`
* `settings.option.visual.customAccentColor`: Added for `pt_PT`
* `settings.option.visual.purplePodcastPlaybackBar`: Added for `pt_PT`
* `settings.option.visual.windowColor`: Added for `pt_PT`
* `term.cast2`: Added for `pt_PT`
* `term.fullscreen`: Added for `pt_PT`
* `term.live`: Added for `pt_PT`
* `term.playpause`: Added for `pt_PT`
* `term.quit`: Added for `pt_PT`
* `term.reload`: Added for `pt_PT`
* `term.themeManaged`: Added for `pt_PT`
* `term.toggleprivate`: Added for `pt_PT`
* `term.webremote`: Added for `pt_PT`
* `term.zoomin`: Added for `pt_PT`
* `term.zoomout`: Added for `pt_PT`
* `term.zoomreset`: Added for `pt_PT`

* `action.tray.next`: Deleted for `pt_PT`
* `action.tray.playpause`: Deleted for `pt_PT`
* `action.tray.previous`: Deleted for `pt_PT`
* `action.tray.quit`: Deleted for `pt_PT`
* `menubar.options.about`: Deleted for `pt_PT`
* `menubar.options.accountsettings`: Deleted for `pt_PT`
* `menubar.options.albums`: Deleted for `pt_PT`
* `menubar.options.artists`: Deleted for `pt_PT`
* `menubar.options.audio`: Deleted for `pt_PT`
* `menubar.options.browse`: Deleted for `pt_PT`
* `menubar.options.cast`: Deleted for `pt_PT`
* `menubar.options.discord`: Deleted for `pt_PT`
* `menubar.options.github`: Deleted for `pt_PT`
* `menubar.options.listennow`: Deleted for `pt_PT`
* `menubar.options.next`: Deleted for `pt_PT`
* `menubar.options.playpause`: Deleted for `pt_PT`
* `menubar.options.previous`: Deleted for `pt_PT`
* `menubar.options.quit`: Deleted for `pt_PT`
* `menubar.options.recentlyAdded`: Deleted for `pt_PT`
* `menubar.options.search`: Deleted for `pt_PT`
* `menubar.options.settings`: Deleted for `pt_PT`
* `menubar.options.songs`: Deleted for `pt_PT`
* `menubar.options.toggleprivate`: Deleted for `pt_PT`
* `menubar.options.webremote`: Deleted for `pt_PT`
* `settings.option.audio.enableAdvancedFunctionality.atmosphereRealizerMode.Z8500`: Deleted for `pt_PT`
* `settings.option.general.keybindings.open`: Deleted for `pt_PT`
